...
//     const tokenAddress = process.env.NEXT_PUBLIC_TOKEN_BASE_A;
//     try{

//       const lock = await fetch("/api/bridge/lock", {
//         method : "POST",
//         body : JSON.stringify({
...
//       console.log("Lock tx hash :", lockData);
      
      
//       const mint = await fetch("/api/bridge/mint", {
//         method : "POST",
//         body : JSON.stringify({
//           user : address,
//           amount: (Number(fromAmount) * 1e18).toString(), 
...
//       console.log("Mint Data haxh", mintData);
...
//       alert('Error during bridge operation.');
//     }
